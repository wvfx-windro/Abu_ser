...
module.exports = {
    ...
    SESSION: process.env.SANA_CODE === undefined ? '' : process.env.SANA_CODE,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Sana-Mwol' : process.env.LOGO_NAME,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ 💝 Sana-Mwol 💝 ‒‒‒⊣' : process.env.BOT_NAME,
    BOTSK: process.env.BOT_NAME === undefined ? 'Sana' : process.env.BOT_NAME,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'Sana💞/💝/✨/📝' : process.env.CMD_LIST,
