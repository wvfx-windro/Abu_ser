...
module.exports = {
    ...
    SESSION: process.env.ABU_SER_CODE === undefined ? '' : process.env.ABU_SER_CODE,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.hizliresim.com/loUtAb.jpg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'TR' : process.env.LANGUAGE.toUpperCase(),
    ALIVEBTN: process.env.ALIVE_BUTTON === undefined ? 'ᴇɴɢᴀɴᴇʏᴜɴᴅ ᴀʙᴜ sᴇʀ🌝' : process.env.ALIVE_BUTTON,
    ...
    BC: process.env.BROADCAST_NAME === undefined ? 'ɪ̄.ᴀᴍ/ꪶ͢ᴀʙᴜ sᴇʀꫂ⁩' : process.env.BROADCAST_NAME,
    ...
    AFPLK: process.env.ABU_PASSWORD === undefined ? false : process.env.ABU_PASSWORD,
    ...
    ABU: process.env.ABU_CAPTION === undefined ? 'ᴍᴀᴅᴇ ʙʏ ᴀʙᴜ sᴇʀ' : process.env.ABU_CAPTION,
    DISBGM: process.env.DISABLE_JID_BGM_FILTER === undefined ? false : process.env.DISABLE_JID_BGM_FILTER,
    STICKERP: process.env.AUTO_STICKER === undefined ? true : convertToBool(process.env.AUTO_STICKER),
    DISSTICKER: process.env.DISABLE_STICKER === undefined ? false : process.env.DISABLE_STICKER,
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ 💝 Abu Ser 💝 ‒‒‒⊣' : process.env.BOT_NAME,
    BOTSK: process.env.BOT_NAME === undefined ? 'Abu Ser' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.imgur.com/TR4CYrZ.jpg' : process.env.ALL_IMG,
    ...
    TALKING_ABU: process.env.TALKING_ABU === undefined ? 'false' : process.env.TALKING_ABU,
