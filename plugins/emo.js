...
if (Config.WORKTYPE == 'private') {
    ...
    SewRavi.addCommand({pattern: 'emo ?(.*)', fromMe: true, desc: des}, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.png, caption: 'Config.BOT'})
    ...
    SewRavi.addCommand({pattern: 'png ?(.*)', fromMe: true,dontAddCMDList: true}, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.png, caption: 'Config.LOGOSK'})
