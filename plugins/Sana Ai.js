...
Asena.addCommand({ pattern: 'sana ?(.*)', desc: fulleva_dsc, fromMe: true,dontAddCommandList: true, usage: '.maalu on / off' }, (async (message, match) => {
